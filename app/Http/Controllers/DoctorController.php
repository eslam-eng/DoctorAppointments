...
use App\Models\DoctorAppointmentType;
...
class DoctorController extends Controller
{
    ...
    {
        $data = Doctor::query()->with('branch')->find($id);
        $department = Services::all();
        $branches = Branch::all();
        return view("admin.doctor.savedoctor", ['id' => $id, 'data' => $data, 'department' => $department, 'branches' => $branches]);
    }
