                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-sm-4">
                                            <ul class="twitter-bs-wizard-nav nav nav-pills flex-column">
                                                <li class="nav-item">
                                                    <a href="#verti-nav-admin-details" class="nav-link"
                                                       data-toggle="tab">
                                                ...
                                                <?php if (env('IS_FORNT') == "1")
                                                {
                                                    ?>
                                                <li class="nav-item">
                                                    <a href="#verti-nav-seller-details" class="nav-link active"
                                                       data-toggle="tab">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#verti-nav-company-document" class="nav-link"
                                                       data-toggle="tab">
                                 ...
                                 <span>{{__("message.Payments Keys")}}</span>
                                                    ...
                                                    <form action="{{url('admin/updatesettingone')}}" method="post"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="verti-nav-phoneno-input">{{__("message.Phone")}}</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="verti-nav-address-input">{{__("message.Address")}}</label>
                                                                    <textarea id="verti-nav-address-input" required
                                                                              name="address" id="address"
                                                                              class="form-control"
                                                                              rows="2"> {{isset($data->address)?$data->address:''}}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                for="verti-nav-phoneno-input">{{__("message.App Store URL")}}</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label
                                                                for="verti-nav-phoneno-input">{{__("message.Play Store URL")}}</label>
                                                ...
                                                <div class="tab-pane" id="verti-nav-company-document">
                                                    <div>
                                                        <form action="{{url('admin/updatesettingtwo')}}" method="post"
                                                            ...
                                                            <div class="form-group">
                                                                <label
                                                                    for="verti-nav-pancard-input">{{__("message.Main Banner")}}</label>
                                                                @if(isset($data->main_banner))
                                                                    <img
                                                                        src="{{asset('image_web').'/'.$data->main_banner}}"
                                                            ...
                                                            <div class="form-group">
                                                                <label
                                                                    for="verti-nav-vatno-input">{{__("message.Favicon")}}</label>
                                                                @if(isset($data->favicon))
                                                                    <img
                                                                        src="{{asset('image_web').'/'.$data->favicon}}">
                                                                    <input type="file" class="form-control"
                                                                           id="verti-nav-pancard-input" name="favicon">
                                                                @else
                                                                    <input type="file" class="form-control"
                                                                           name="favicon" id="verti-nav-pancard-input"
                                                                           required="">
                                                                @endif
                                                            </div>
                                                            <div class="form-group">
                                                                <label
                                                                    for="verti-nav-cstno-input">{{__("message.LOGO")}}</label>
                                                                @if(isset($data->logo))
                                                                    <img src="{{asset('image_web').'/'.$data->logo}}"
                                                                         style="width: 250px;">
                                                                    <input type="file" class="form-control"
                                                                           id="verti-nav-pancard-input" name="logo">
                                                                @else
                                                            ...
                                                            <div class="form-group">
                                                                <label
                                                                    for="verti-nav-servicetax-input">{{__("message.App Banner")}}</label>
                                                                @if(isset($data->app_banner))
                                                                    <img
                                                                        src="{{asset('image_web').'/'.$data->app_banner}}"
                                                                        style="width: 250px;">
                                                                    <input type="file" class="form-control"
                                                                           id="verti-nav-pancard-input"
                                                                           name="app_banner">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @if(isset($data->icon1))
                                                                    <img src="{{asset('image_web').'/'.$data->icon1}}"
                                                                         style="width: 250px;">
                                                                    <input type="file" class="form-control"
                                                                           id="verti-nav-pancard-input" name="icon1">
                                                                @else
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @if(isset($data->icon2))
                                                                    <img src="{{asset('image_web').'/'.$data->icon2}}"
                                                                         style="width: 250px;">
                                                                    <input type="file" class="form-control"
                                                                           id="verti-nav-pancard-input" name="icon2">
                                                                @else
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @if(isset($data->icon3))
                                                                    <img src="{{asset('image_web').'/'.$data->icon3}}"
                                                                         style="width: 250px;">
                                                                    <input type="file" class="form-control"
                                                                           id="verti-nav-pancard-input" name="icon3">
                                                                @else
                                        ...
                                        <div class="tab-pane active" id="verti-nav-admin-details">
                                            <form action="{{url('admin/updatesettingfour')}}" method="post"
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        for="verti-nav-phoneno-input">{{__("message.Commission")}}</label>
                                                    <input type="number" required name="commission"
                                                           value="{{isset($data->commission)?$data->commission:''}}"
                                                           class="form-control" id="verti-nav-phoneno-input" min="1"
                                                           step="0.01" max="100">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="timezone" id="timezone"
                                                        ...
                                                        @foreach($timezone as $tz=>$value)
                                                            <option
                                                                value="{{$tz}}" <?= $data->timezone == $tz ? ' selected="selected"' : ''; ?>>{{$value}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               id="formrow-customCheck" name="doctor_approved"
                                                               value="1" <?= isset($data->doctor_approved) && $data->doctor_approved == '1' ? 'checked="checked"' : "" ?> >
                                                ...
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                               ...
                                                               <?= isset($data->is_rtl) && $data->is_rtl == '1' ? 'checked="checked"' : "" ?> name="is_rtl"
                                                               value="1">
                                                        <label class="custom-control-label"
                                                               for="formrow-customCheck11">{{__("message.Is RTL")}} (arabic)</label>
                                                    </div>
                                                </div>
                                                <div class="mt-4">
                                                    @if(false)
